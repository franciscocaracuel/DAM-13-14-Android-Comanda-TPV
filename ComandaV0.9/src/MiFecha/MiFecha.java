...
public class MiFecha implements Serializable{
	...
	//GregorianCalendar no se puede guardar en DB4O por eso se pone transient y se añade la variable millis
	...
	public MiFecha(){
		this(new GregorianCalendar(), "", new GregorianCalendar().getTimeInMillis()+"");
	}
